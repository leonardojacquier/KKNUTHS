...
- Foto do card, da página e da ficha é um recorte 4:3 da foto do banner (`mezcladora-mortero.jpg`), salvo em `mezcladora-de-mortero-n50.jpg`. O desenho de linha do manual foi publicado primeiro e o dono rejeitou ("ficou ruim esse desenho") — não voltar a ele.
