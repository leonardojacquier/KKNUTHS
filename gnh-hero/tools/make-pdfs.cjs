...
const LOGO_IMG = LOGO_B64
  ? `<img src="data:image/png;base64,${LOGO_B64}" style="height:14px;width:auto;vertical-align:middle">`
  : 'GNH'
...
;(async () => {
  ...
  for (const f of files) {
    ...
    await page.pdf({
      ...
      footerTemplate: `<div style="width:100%;font-size:9px;color:#7c8698;text-align:center;font-family:Arial,sans-serif">
