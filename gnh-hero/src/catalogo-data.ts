    ...
    groups: [
      ...
      },
      {
        ...
        products: [
          ...
          { name: 'Grupo Electrógeno Diésel 38 kVA', img: '../img/prod/generador.png', note: 'Motor Ricardo HZ4ND, 400 V / 50 Hz, cabina súper silenciosa y tablero ATS de arranque automático.',
            tags: ['energia', 'electricidad', 'luz', 'corte de luz', 'trifasico', 'silencioso', 'emergencia', 'generador', 'kva', 'respaldo', 'evento', 'ricardo', 'ats', 'grupo electrogeno', 'hz38gf', 'generador electrico'] },
...
export const SPECS: Record<string, { h: string[]; r: string[][] }> = {
  ...
  'Grúa Araña': { h: ['Modelo', 'Capacidad', 'Radio máx.', 'Altura máx.', 'Ancho de paso', 'Peso', 'Ficha'], r: [
    ['ZS-1.5T','1,5 t','6 m','6,5 m','0,65 m','1.300 kg','<a href="/fichas/grua-arana-1-5t.html">Ver ficha</a>'],
    ['ZS-3T','3 t','10,5 m','10,8 m','0,80 m','3.000 kg','<a href="/fichas/grua-arana-3t.html">Ver ficha</a>'],
    ['ZS-4T','4 t','13 m','15 m','1,00 m','3.000 kg','<a href="/fichas/grua-arana-4t.html">Ver ficha</a>'],
    ['ZS-5T','5 t','15 m','17 m','1,50 m','6.100 kg','<a href="/fichas/grua-arana-5t.html">Ver ficha</a>'],
    ['ZS-8T','8 t','18 m','21 m','1,60 m','8.700 kg','<a href="/fichas/grua-arana-8t.html">Ver ficha</a>'],
    ['ZS-10T','10 t','18,5 m','19,5 m','1,80 m','10.500 kg','<a href="/fichas/grua-arana-10t.html">Ver ficha</a>'],
    ['ZS-12T','12 t','19 m','21 m','1,83 m','12.500 kg','<a href="/fichas/grua-arana-12t.html">Ver ficha</a>'],
    ['ZS-16T','16 t','23 m','25 m','2,70 m','16.500 kg','<a href="/fichas/grua-arana-16t.html">Ver ficha</a>'],
  ] },
  // Grupo electrógeno HZ38GF — traducido de la ficha del fabricante (38kva diesel
  // generator tech. specification). Dos filas del original quedaron fuera por venir
  // contradictorias: "Rate speed 600±50 r/min" (choca con las 1500 rpm de la potencia
  // y con el ralentí de 945) y "Insulation grade ≥+10%Un", que no es un grado de
  // aislamiento sino un valor corrido de la fila de al lado.
  'Grupo Electrógeno Diésel 38 kVA': { h: ['Dato', 'Valor'], r: [
    ['Modelo del grupo', 'HZ38GF'],
    ['Potencia', '38 kVA / 30,4 kW'],
    ['Tensión', '400 / 230 V'],
    ['Frecuencia', '50 Hz'],
    ['Corriente', '54,72 A'],
    ['Conexión', 'Trifásica, cuatro hilos'],
    ['Tipo', 'Cabina súper silenciosa, con sistema de protección, panel digital y ATS'],
    ['Medidas (L×A×H)', '2.100 × 950 × 1.200 mm'],
    ['Peso neto', '950 kg'],
    ['Motor — marca / modelo', 'Ricardo — HZ4ND'],
    ['Motor — tipo', 'Diésel 4 tiempos, refrigerado por agua, en línea, inyección directa'],
    ['Motor — potencia / régimen', '46 kW a 1.500 rpm'],
    ['Motor — admisión', 'Turbo con intercooler'],
    ['Motor — cilindros', '4'],
    ['Motor — diámetro × carrera', '105 × 120 mm'],
    ['Motor — cilindrada', '3,6 L'],
    ['Motor — consumo', '≤ 195 g/kW·h'],
    ['Motor — arranque', 'Eléctrico 24 V CC'],
    ['Motor — refrigeración', 'Circuito cerrado de agua'],
    ['Motor — lubricación', 'Presión y salpicadura · 30 L de aceite'],
    ['Motor — presión de aceite', '580–648 kPa (≥ 100 kPa en ralentí)'],
    ['Motor — ralentí', '945 rpm'],
    ['Motor — temperatura de escape', '≤ 550 °C'],
    ['Alternador — marca / modelo', 'WFSTF — STF/38'],
    ['Alternador — salida', '40 kVA / 32 kW'],
    ['Alternador — factor de potencia', '0,8'],
    ['Alternador — regulación de tensión', '± 0,25 %'],
    ['Alternador — estabilidad de tensión', '< 5 %'],
    ['Alternador — excitación', '+20 % / −15 % Un'],
    ['Alternador — grado de protección', 'IP23'],
    ['Alternador — sobrecarga', '10 s'],
  ] },
