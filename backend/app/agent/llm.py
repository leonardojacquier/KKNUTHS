...
_SYSTEM = {
    "pt": (
        ...
        "1d) MÃO FEITA: hero_final_hand e showdown_hands do contexto são o "
        "GABARITO do que cada um fez no board (calculado, não estimado). "
        "Use-os LITERALMENTE — PROIBIDO recontar de cabeça: dizer 'trinca "
        "de J' quando o contexto diz 'dois pares (J e 10)' é erro grave que "
        "o aluno flagra na hora.\n"
