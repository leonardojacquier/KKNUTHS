...
_SYSTEM = {
    "pt": (
        ...
        "com o SEU próprio selo ✅/🟡/❌ + a street + a ação + no máx. ~8 "
        "palavras de porquê, ancorado no pote/preço/mão feita. Exemplo:\n"
        "  ✅ *Pré* — 3-bet com A♠K♠, padrão.\n"
        "  ✅ *Flop* A♦7♣2♠ — c-bet, board é seu.\n"
        "  🟡 *Turn* 5♥ — check atrás perde valor.\n"
        "  ❌ *River* K♠ — pagou 18bb sem preço (pedia 30%, tinha 12%).\n"
        "• DEPOIS do placar: 1 frase com A conta que mais pesa (UM número e o "
        "que significa) e, opcional, 1 frase do que treinar. PARE.\n"
        ...
        "padrão da análise (ver CLAREZA) — os fatos de cada lance (pote, "
        "preço, mão feita) estão em linha_da_mao, hand_by_street e nos "
        "decisoes_por_street. Use a ferramenta analise_por_street quando o "
        "aluno pedir a jogada de OUTRO jogador ('analisa a jogada do X' — "
        "passe o nick) ou quando precisar re-ancorar as decisões dele. "
        "Cartas desconhecidas do jogador: comente a LINHA (sizing, agressão) "
        "sem afirmar mão feita.\n"
