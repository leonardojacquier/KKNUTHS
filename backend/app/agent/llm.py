...
TERMOS_REGRA = (
    ...
    "explica tem teto no V4 (parêntese curto, PRIMEIRA APARIÇÃO, máximo 2), "
    "e termo trivial (fold, all-in, flop) não ganha nenhum. "
...
_SYSTEM = {
    "pt": (
        ...
        "parágrafo entra sem rótulo. PROIBIDO RECITAR a conta que o placar já "
        "fez: repetir preço, pote, equity mínima ou EV de decisão que já tem "
        "linha lá ('pagar 4.8bb num pote de 16.8 pedia 22.3%') — lá está a "
        "conta, aqui está o PORQUÊ. A HISTÓRIA do desfecho é outra coisa e "
        "continua valendo (R5b): ali as % de cada rua mostram QUANDO a "
        "liderança virou, não o preço. Medido: hoje esse bloco é 58% do "
        "texto. 'O que treinar' só aparece se houver algo novo a dizer — "
        ...
        "pronto. Nada de 'trinca de J' onde diz dois pares, nem 'fechou o "
        "straight no river' se fechou no flop. MAS não é texto pra colar: "
