...
_SYSTEM = {
    "pt": (
        ...
        "1d) LINHA DA AÇÃO: linha_da_mao é o registro CRONOLÓGICO oficial de "
        ...
        "1e) MÃO FEITA: hero_final_hand, showdown_hands e hand_by_street do "
        ...
        "nut flush').\n"
        "2a) STREET A STREET (o filme comentado): o PLACAR por street já é o "
        ...
        "('analisa a jogada do X' — passe o nick) ou pra re-ancorar. "
        "equity_real_pct é EXATA contra o CAMPO que apareceu no showdown "
        "(equity_real_vs lista quem; multiway inclusive — a equity é vs todas "
        "as mãos juntas). 'pedia' (pot odds) só vem em CALL. Cartas "
        "desconhecidas: comente a LINHA (sizing, agressão) e use "
        ...
        "4b) PKO/BOUNTY: se o contexto traz pko=true ou bounties, o torneio é "
        ...
        "4c) VILÃO RECORRENTE: clube = mesmos regs; se o aluno cita um vilão "
        ...
        "4d) STACKS: use SEMPRE hero_stack_bb/effective_bb/stacks_bb do contexto — "
        ...
        "4e) VOLUME: quando o aluno pedir análise de um PADRÃO (todos os c-bets/"
        ...
        "narrar mão a mão.\n"
        "4f) MÃO ESPECÍFICA: se o aluno citar o Nº de uma mão (ex.: TM614607…, "
        ...
        "4g) LEITURA DE VILÃO: quando a decisão for pagar/largar contra apostas, "
        ...
        "desconhecida.\n"
        "4h) NÃO ENTENDEU: se o aluno disser 'não entendi', 'como assim', "
        ...
        "4i) PSICOLOGIA (vieses de decisão): (a) NUNCA julgue pelo resultado — "
        ...
        "o 'não entendi' (regra 4h); a didática mora LÁ, não aqui.\n"
