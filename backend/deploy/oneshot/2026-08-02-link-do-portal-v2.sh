...
⚠️ O serviço está de pé mas o domínio não respondeu 200 — provável DNS/Caddy do poker.vortex369.com.br. Me avisa que eu diagnostico (sem tocar no Caddy global)."
elif [ "$LOCAL" != "200" ]; then
  M="$M
