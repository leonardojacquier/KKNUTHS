...
export default function GeometrySection({ data, onChange, tipo }: Props) {
  ...
  return (
    <div>
      <h2 className="section-title">Geometria e Juntas</h2>
      ...
      <div className="p-4 border border-gray-200 rounded-lg mb-4">
        <div className="flex items-center gap-3 mb-3">
          ...
          <label htmlFor="dow" className="font-medium text-gray-700">Barras de Transferência (Dowels) – juntas transversais</label>
        </div>
        {geo.dowels && (
      ...
      <div className="p-4 border border-gray-200 rounded-lg mb-4">
        <div className="flex items-center gap-3 mb-3">
          ...
          <label htmlFor="tie" className="font-medium text-gray-700">Barras de Ligação (Tie Bars) – juntas longitudinais</label>
        </div>
        {geo.tie_bars && (
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select className="input-field"
                ...
                <option value="">Automático (∅12)</option>
      ...
      <div className="p-3 bg-gray-50 rounded-lg text-sm text-gray-600">
        <strong>Resumo da malha:</strong> {num_x} placas × {num_y} placas = <strong className="text-blue-700">{num_placas} placas</strong> |
        Área: {geo.comprimento_placa} × {geo.largura_placa} m = <strong>{(geo.comprimento_placa * geo.largura_placa).toFixed(0)} m²</strong>
      </div>
    </div>
  );
}
